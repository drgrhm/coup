...
def up(env, u, delta, k0=1, epsilon_min=0, n=None, save_mod=20, doubling_condition="new"):
        ...
        for i in I.keys():
            ...
            if m >= num_instances:
                if epsilon_min == 0: # not targeting a specific epsilon
                    ...
                    print("\nERROR: {} ran out of instances at m={} before reaching epsilon={}, current epsilon={}\n".format(alg_name, m, epsilon_min, epsilon_star))
                    raise IndexError
