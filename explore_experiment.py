...
if __name__ == "__main__":
    ...
    n_max = env.num_configs
    m_max = env.num_instances
    ...
    plt.savefig("img/explore_experiment_eps_gam_{}_{}_{}_{}.pdf".format(args.seed, args.dataseed, u_str, args.dataset), bbox_inches='tight')
    plt.clf()
    ...
    plt.savefig("img/explore_experiment_time_eps_{}_{}_{}_{}.pdf".format(args.seed, args.dataseed, u_str, args.dataset), bbox_inches='tight')
    plt.clf()
    ...
    plt.xlabel("Total time (CPU days)", fontsize=fs['axis'])
    plt.ylabel("$\\gamma$ guaranteed", fontsize=fs['axis'])
    plt.savefig("img/explore_experiment_time_gam_{}_{}_{}_{}.pdf".format(args.seed, args.dataseed, u_str, args.dataset), bbox_inches='tight')
    plt.clf()
