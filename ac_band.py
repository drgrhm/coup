...
def ac_band(env, conf_space, num_instances, budget, k, alpha,  delta , N = None, u=None):
    ...
    for e in range(1, epochs+1):
        ...
        incumbent, cse_cpu_rt, cse_wallclock_rt = cse(env, confs, k, roh_e, instances, R, u=u)
